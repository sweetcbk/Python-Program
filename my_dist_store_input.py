flag = 'y'
#capitals = str (input({"India" : "New Delhi", "USA" : "Washington DC","Nepal": "Kathmandu","Ukraine" : "Kyiv"}))
capitals = str (input({"Enter Country : Capital"}))
#usr_input=capitals.split(",")
...
while (flag1 =='Y' or flag1 =='y'):    
    ...
    if (choice == '1'):
        ...
        capitals.update  (input("Enter County : Capital"))
